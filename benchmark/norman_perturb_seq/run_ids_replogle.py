...
DATA_DIR = Path(os.environ.get("ALS_REPLOGLE_DATA_DIR", "data/external/replogle"))
OUTPUT_DIR = Path(os.environ.get("ALS_REPLOGLE_OUTPUT_DIR", "data/external/replogle_results"))
